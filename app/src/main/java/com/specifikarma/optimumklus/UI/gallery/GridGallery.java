...
import com.specifikarma.optimumklus.UI.card.Cards;
import com.specifikarma.optimumklus.R;


public class GridGallery extends Cards implements View.OnClickListener {
    ...
    private void cameraFlipAnim(@NonNull View view) {
        ...
        view.findViewById(R.id.gallery_back).setScaleX(Float.parseFloat(getString(R.string.zoom)));
        view.findViewById(R.id.gallery_back).setScaleY(Float.parseFloat(getString(R.string.zoom)));
    }
